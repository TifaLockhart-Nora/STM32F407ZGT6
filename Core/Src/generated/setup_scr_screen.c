...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_btn_1, 53, 108);
    ...
    lv_obj_set_pos(ui->screen_sw_1, 136, 63);
    ...
    lv_obj_set_pos(ui->screen_bar_1, 60, 187);
    lv_obj_set_size(ui->screen_bar_1, 185, 14);
    ...
    lv_obj_set_pos(ui->screen_btn_2, 176, 108);
