##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.10.0-B14] date: [Tue Dec 23 10:35:29 CST 2025] 
##########################################################################################################################
...
# debug build?
DEBUG = 1
# optimization (使用 -O2 或 -O3 可显著提升LVGL性能)
# -Og: 调试优化, -O2: 性能优化, -O3: 最大性能优化
OPT = -O2
